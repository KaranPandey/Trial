    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mAuth.createUserWithEmailAndPassword(mEmail,mPass).addOnCompleteListener(CustomerActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
        ...
        log.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final String mEmail = email.getText().toString();
                final String mPass = pass.getText().toString();
                mAuth.signInWithEmailAndPassword(mEmail , mPass).addOnCompleteListener(CustomerActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(!task.isSuccessful())
                        {
